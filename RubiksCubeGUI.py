...
def displayCube():
    ...
    for i in range(2, 4):
        for j in range(4, 6):
            tkinter.Label(window, text=aprime[aprimecounter], fg="white", bg=colors[aprime[aprimecounter]]).grid(row=i,
                                                                                                                 column=j)
            aprimecounter += 1
    for i in range(4, 6):
        for j in range(2, 4):
            tkinter.Label(window, text=bprime[bprimecounter], fg="white", bg=colors[bprime[bprimecounter]]).grid(row=i,
                                                                                                                 column=j)
            bprimecounter += 1
    for i in range(6, 8):
        for j in range(2, 4):
            tkinter.Label(window, text=cprime[cprimecounter], fg="white", bg=colors[cprime[cprimecounter]]).grid(row=i,
                                                                                                                 column=j)
            cprimecounter += 1
